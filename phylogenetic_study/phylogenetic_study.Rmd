...
Drop some of these data points (TODO: until the final data file is procured).
...
For the time being, we drop the same inventories as we did with the ejectives (TODO: incorporate new data file).
...
We remove the UPSID inventory for the time being given the trump hierarchy. TODO: fix this in the data file.
