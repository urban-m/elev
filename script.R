...
fituvulars<-(fitted(elevmodelupsiduvulars, re_formula=NA, summary=TRUE))
summary(fit)
...
fit<-(fitted(elevmodelejectives, re_formula=NA, summary=TRUE))
summary (fit)
...
fit<-(fitted(elevmodelupsidejectives, re_formula=NA, summary=TRUE))
summary (fit)
